      ...
      <div class="detail-content">
        <div class="detail-content-top">
          ...
          <div class="top-right">
            ...
            <div class="meta">品牌：{{ detailData.pinpai }}</div>
            <div class="meta">规格：{{ detailData.guige }}</div>
            <div class="meta">材质：{{ detailData.caizhi }}</div>
            <div class="meta">重量：{{ detailData.zhongliang }}</div>
            <div class="actions">
